var Actor, Box, Circle, CircleActor, Controller, Game, Keys, Loader, MathHelpers, Polygon, SquareActor, Stage, Vector,
...
SquareActor = (function(superClass) {
  ...
  SquareActor.prototype.drawDebug = function() {
    ...
    context.closePath();
    context.rotate(-this.direction);
    return context.translate(-this.position.x, -this.position.y);
  };
...
CircleActor = (function(superClass) {
  ...
  CircleActor.prototype.drawDebug = function(colour) {
    ...
    context.closePath();
    context.rotate(-this.direction);
    return context.translate(-this.body.pos.x, -this.body.pos.y);
  };
...
Loader = {
  ...
  loadImage: function(key, src) {
    ...
    downloadingImage.onload = function() {
      return Loader.images[key] = downloadingImage;
    };
...
Game = (function() {
  ...
  Game.prototype.render = function() {
    ...
    this.canvas.ctx.font = "normal 16pt Arial";
    this.canvas.ctx.fillText(Math.round(this.actualFps), this.canvas.width - 30, 20);
    if (this.stage != null) {
